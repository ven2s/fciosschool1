...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    return [[[DataCenter defaultData] dataForWeather:self.wetherType] count];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // Configure the cell...
    cell.textLabel.text = [[[DataCenter defaultData] dataForWeather:self.wetherType] objectAtIndex:indexPath.row];
